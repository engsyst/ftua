...
import ua.nure.ostpc.malibu.shedule.client.SheduleDraftService;
...
public class SheduleDraftServiceImpl extends RemoteServiceServlet implements
SheduleDraftService {
	private UserDAO userDAO;
	private static final Logger log = Logger.getLogger(SheduleDraftServiceImpl.class);

	public SheduleDraftServiceImpl() {
		super();
