...
public class Demo {
	...
	public static void main(String[] args) throws SQLException, ParseException {
		...
		Date startDate = new Date(sdf.parse("01-06-2014").getTime());
		Date endDate = new Date(sdf.parse("30-06-2014").getTime());
		Set<Schedule> schedules = scheduleDAO.readSchedules(startDate, endDate);
