...
public class ScheduleManagerEntryPoint implements EntryPoint {
	...
	// horizontalPanel_12.setCellVerticalAlignment(absolutePanel_22,
	// HasVerticalAlignment.ALIGN_MIDDLE);
	// horizontalPanel_12.setCellHorizontalAlignment(absolutePanel_22,
	...
	private void drawPrimaryPage() {
		...
		horizontalPanel.add(absolutePanel_4);
		horizontalPanel.setCellHorizontalAlignment(absolutePanel_4, HasHorizontalAlignment.ALIGN_RIGHT);
		absolutePanel_4.setSize("100%", "100%");
		...
		dockPanel_2.setCellVerticalAlignment(nlnlblNewInlinelabel_1, HasVerticalAlignment.ALIGN_MIDDLE);
		dockPanel_2.setCellHorizontalAlignment(nlnlblNewInlinelabel_1, HasHorizontalAlignment.ALIGN_RIGHT);
		...
		horizontalPanel_6.setCellVerticalAlignment(absolutePanel_10, HasVerticalAlignment.ALIGN_MIDDLE);
		horizontalPanel_6.setCellHorizontalAlignment(absolutePanel_10, HasHorizontalAlignment.ALIGN_CENTER);
		absolutePanel_10.setSize("100%", "100%");
		...
		dockPanel_4.setCellVerticalAlignment(logoutFormPanel, HasVerticalAlignment.ALIGN_MIDDLE);
		dockPanel_4.setCellHorizontalAlignment(logoutFormPanel, HasHorizontalAlignment.ALIGN_CENTER);
		...
		dockPanel_4.setCellVerticalAlignment(setProfile, HasVerticalAlignment.ALIGN_MIDDLE);
		dockPanel_4.setCellHorizontalAlignment(setProfile, HasHorizontalAlignment.ALIGN_CENTER);
		AbsolutePanel absolutePanel_8 = new AbsolutePanel();
		...
		horizontalPanel_2.setCellHeight(inlineLabel_2, "Редактировать ближайший");
		...
		InlineLabel inlineLabel_1 = new InlineLabel("Управление графиками работ");
		...
		setProfile.addClickHandler(new com.google.gwt.event.dom.client.ClickHandler() {
			
			@Override
			public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
				UserSettingSimplePanel sp = new UserSettingSimplePanel();
				MainAbsolutePanel.add(sp);
			}
		});
	}
