...
public interface StartSettingServiceAsync {
	...
	void getOnlyOurClubs(AsyncCallback<Collection<Club>> callback) throws IllegalArgumentException;
	void getDictionaryClub(AsyncCallback<Map<Long, Club>> callback) throws IllegalArgumentException;
